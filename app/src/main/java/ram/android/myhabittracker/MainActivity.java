...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button samplebutton = (Button) findViewById(R.id.next_button);
        samplebutton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v)
            {
                ...
                String sampleNumberSignedEditText = durationtxt.getText().toString();
                int habitDuration = Integer.parseInt(sampleNumberSignedEditText);
        ...
        samplebutton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                EditText samplePersonEditTextView = (EditText) findViewById(R.id.search);
